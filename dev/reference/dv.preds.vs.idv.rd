...
encapsulating arguments to the xpose.plot.default function."><meta property="og:description" content="This is a compound plot consisting of plots of observations (DV), individual
predictions (IPRED), and population predictions (PRED) against the
independent variable (IDV), a specific function in Xpose 4.  It is a wrapper
encapsulating arguments to the xpose.plot.default function."><meta name="robots" content="noindex"></head><body>
    ...
    <small class="nav-text text-danger me-auto" data-bs-toggle="tooltip" data-bs-placement="bottom" title="In-development version">4.7.4.9000</small>
