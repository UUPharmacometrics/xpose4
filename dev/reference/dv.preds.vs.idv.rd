<!DOCTYPE html>
<!-- Generated by pkgdown: do not edit by hand --><html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta charset="utf-8"><meta http-equiv="X-UA-Compatible" content="IE=edge"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Observations (DV), individual predictions (IPRED) and population predictions
(IPRED) plotted against the independent variable (IDV), for Xpose 4 — dv.preds.vs.idv • xpose4</title><!-- jquery --><script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.4.1/jquery.min.js" integrity="sha256-CSXorXvZcTkaix6Yvo6HppcZGetbYMGWSFlBw8HfCJo=" crossorigin="anonymous"></script><!-- Bootstrap --><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.4.1/css/bootstrap.min.css" integrity="sha256-bZLfwXAP04zRMK2BjiO8iu9pf4FbLqX6zitd+tIvLhE=" crossorigin="anonymous"><script src="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.4.1/js/bootstrap.min.js" integrity="sha256-nuL8/2cJ5NDSSwnKD8VqreErSWHtnEP9E7AySL+1ev4=" crossorigin="anonymous"></script><!-- bootstrap-toc --><link rel="stylesheet" href="../bootstrap-toc.css"><script src="../bootstrap-toc.js"></script><!-- Font Awesome icons --><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.12.1/css/all.min.css" integrity="sha256-mmgLkCYLUQbXn0B1SRqzHar6dCnv9oZFPEC1g1cwlkk=" crossorigin="anonymous"><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.12.1/css/v4-shims.min.css" integrity="sha256-wZjR52fzng1pJHwx4aV2AO3yyTOXrcDW7jBpJtTwVxw=" crossorigin="anonymous"><!-- clipboard.js --><script src="https://cdnjs.cloudflare.com/ajax/libs/clipboard.js/2.0.6/clipboard.min.js" integrity="sha256-inc5kl9MA1hkeYUt+EC3BhlIgyp/2jDIyBLS6k3UxPI=" crossorigin="anonymous"></script><!-- headroom.js --><script src="https://cdnjs.cloudflare.com/ajax/libs/headroom/0.11.0/headroom.min.js" integrity="sha256-AsUX4SJE1+yuDu5+mAVzJbuYNPHj/WroHuZ8Ir/CkE0=" crossorigin="anonymous"></script><script src="https://cdnjs.cloudflare.com/ajax/libs/headroom/0.11.0/jQuery.headroom.min.js" integrity="sha256-ZX/yNShbjqsohH1k95liqY9Gd8uOiE1S4vZc+9KQ1K4=" crossorigin="anonymous"></script><!-- pkgdown --><link href="../pkgdown.css" rel="stylesheet"><script src="../pkgdown.js"></script><meta property="og:title" content="Observations (DV), individual predictions (IPRED) and population predictions
(IPRED) plotted against the independent variable (IDV), for Xpose 4 — dv.preds.vs.idv"><meta property="og:description" content="This is a compound plot consisting of plots of observations (DV), individual
...
encapsulating arguments to the xpose.plot.default function."><meta name="robots" content="noindex"><!-- mathjax --><script src="https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.5/MathJax.js" integrity="sha256-nvJJv9wWKEm88qvoQl9ekL2J+k/RWIsaSScxxlsrv8k=" crossorigin="anonymous"></script><script src="https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.5/config/TeX-AMS-MML_HTMLorMML.js" integrity="sha256-84DKXVJXs0/F8OTMzX4UR909+jtl4G7SPypPavF+GfA=" crossorigin="anonymous"></script><!--[if lt IE 9]>
  ...
  <div class="container">
    <div class="navbar-header">
      ...
      <span class="navbar-brand">
        ...
        <span class="version label label-danger" data-toggle="tooltip" data-placement="bottom" title="In-development version">4.7.1.9001</span>
      </span>
    </div>
...
<li>
  ...
  <a href="https://github.com/UUPharmacometrics/xpose4/" class="external-link">
  ...
  <div class="col-md-9 contents">
    ...
    <h1>Observations (DV), individual predictions (IPRED) and population predictions
(IPRED) plotted against the independent variable (IDV), for Xpose 4</h1>
    <small class="dont-index">Source: <a href="https://github.com/UUPharmacometrics/xpose4/blob/HEAD/R/dv.preds.vs.idv.R" class="external-link"><code>R/dv.preds.vs.idv.R</code></a></small>
    <div class="hidden name"><code>dv.preds.vs.idv.rd</code></div>
    </div>

    <div class="ref-description">
    <p>This is a compound plot consisting of plots of observations (DV), individual
predictions (IPRED), and population predictions (PRED) against the
independent variable (IDV), a specific function in Xpose 4.  It is a wrapper
encapsulating arguments to the <code>xpose.plot.default</code> function.</p>
    </div>

    <div id="ref-usage">
    <div class="sourceCode"><pre class="sourceCode r"><code><span class="fu">dv.preds.vs.idv</span><span class="op">(</span>
  <span class="va">object</span>,
  ylb <span class="op">=</span> <span class="st">"Observations/Predictions"</span>,
  layout <span class="op">=</span> <span class="fu"><a href="https://rdrr.io/r/base/c.html" class="external-link">c</a></span><span class="op">(</span><span class="fl">3</span>, <span class="fl">1</span><span class="op">)</span>,
  smooth <span class="op">=</span> <span class="cn">TRUE</span>,
  scales <span class="op">=</span> <span class="fu"><a href="https://rdrr.io/r/base/list.html" class="external-link">list</a></span><span class="op">(</span><span class="op">)</span>,
  <span class="va">...</span>
<span class="op">)</span></code></pre></div>
    ...
    <h2>Arguments</h2>
    <dl><dt>object</dt>
<dd><p>An xpose.data object.</p></dd>
<dt>ylb</dt>
<dd><p>A string giving the label for the y-axis. <code>NULL</code> if none.</p></dd>
<dt>layout</dt>
<dd><p>A list controlling the number of columns and rows in a
compound plot. The default is 2 columns and 1 row.</p></dd>
<dt>smooth</dt>
<dd><p>Logical value indicating whether an x-y smooth should be
superimposed.  The default is TRUE.</p></dd>
<dt>scales</dt>
<dd><p>A list to be used for the <code>scales</code> argument in
<code>xyplot</code>.</p></dd>
<dt>...</dt>
<dd><p>Other arguments passed to <code>link{xpose.plot.default}</code>.</p></dd>
</dl></div>
    <div id="value">
    <h2>Value</h2>
    <p>Returns a compound plot comprising plots of observations (DV),
individual predictions (IPRED), and population predictions (PRED) against
the independent variable (IDV).</p>
    </div>
    <div id="details">
    <h2>Details</h2>
    <p>A wide array of extra options controlling <code>xyplots</code> are available. See
<code><a href="xpose.plot.default.html">xpose.plot.default</a></code> and <code><a href="xpose.panel.default.html">xpose.panel.default</a></code> for
details.</p>
    </div>
    <div id="see-also">
    <h2>See also</h2>
    <div class="dont-index"><p><code><a href="dv.vs.idv.html">dv.vs.idv</a></code>, <code><a href="ipred.vs.idv.html">ipred.vs.idv</a></code>,
<code><a href="pred.vs.idv.html">pred.vs.idv</a></code>, <code><a href="xpose.plot.default.html">xpose.plot.default</a></code>,
<code><a href="xpose.panel.default.html">xpose.panel.default</a></code>, <code><a href="https://rdrr.io/pkg/lattice/man/xyplot.html" class="external-link">xyplot</a></code>,
<code><a href="xpose.prefs-class.html">xpose.prefs-class</a></code>, <code><a href="xpose.data-class.html">xpose.data-class</a></code></p>
...
<code><a href="xpose4-package.html">xpose4-package</a></code></p></div>
    ...
    <div id="author">
    <h2>Author</h2>
    <p>E. Niclas Jonsson, Mats Karlsson, Andrew Hooker &amp; Justin Wilkins</p>
    </div>

    <div id="ref-examples">
    <h2>Examples</h2>
    <div class="sourceCode"><pre class="sourceCode r"><code><span class="r-in"></span>
<span class="r-in"><span class="co">## Here we load the example xpose database </span></span>
<span class="r-in"><span class="va">xpdb</span> <span class="op">&lt;-</span> <span class="va">simpraz.xpdb</span></span>
<span class="r-in"></span>
<span class="r-in"><span class="fu">dv.preds.vs.idv</span><span class="op">(</span><span class="va">xpdb</span><span class="op">)</span></span>
<span class="r-plt img"><img src="dv.preds.vs.idv-1.png" alt="" width="700" height="433"></span>
<span class="r-in"></span>
</code></pre></div>
    </div>
  </div>
