...
#' @return Returns a stack of xyplots of |IWRES| vs IPRED, conditioned by
#' covariates.
#' @author E. Niclas Jonsson, Mats Karlsson, Andrew Hooker & Justin Wilkins
#' @seealso \code{\link{absval.iwres.vs.ipred}},
#' \code{\link{xpose.plot.default}}, \code{\link[lattice]{xyplot}},
